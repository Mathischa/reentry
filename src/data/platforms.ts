...
export const PLATFORMS: Platform[] = [
  ...
  /* ─── MONABANQ ────────────────────────────────────────── */
  {
    ...
    bonusFilleul: 'jusqu\'à 280 €',
    bonusParrain: '30 € – 50 €',
    bonusTotal: 'jusqu\'à 330 €',
    highlight: 'Jusqu\'à 280€ pour le filleul en cumulant ouverture + alimentation + activation carte. Parrain : 30€ (Pratiq+/Uniq) ou 50€ (Uniq+).',
    badge: 'Web & App',
    badgeColor: '#f97316',
    minDeposit: '300 € dans le mois (pour débloquer 60 €)',
    timeline: 'Parrain : 60 jours après ouverture · Filleul : échelonné sur 3 mois',
    lastChecked: 'Avril 2026',
    sourceUrl: 'https://www.monabanq.com/fr/parrainage.html',
    reliability: 'élevée',
    recommended: true,
    offerNote: 'Prime filleul : 80 € ouverture + 60 € si versement ≥ 300 € + 40 € activation carte + 80 € offre bienvenue = jusqu\'à 280 € combinés',
    conditions: [
      'Filleul : première ouverture de compte courant Monabanq (jamais eu de compte)',
      'Comptes éligibles : Pratiq+, Uniq, Uniq+ (hors comptes jeunes, PratiqPro, offres partenaires)',
      'Parrain reçoit 30 € (filleul ouvre Pratiq+ ou Uniq) ou 50 € (filleul ouvre Uniq+)',
      'Prime parrain créditée 60 jours après l\'ouverture du compte filleul',
      'Filleul : 80 € à l\'ouverture + 60 € si versement ≥ 300 € dans le mois + 40 € après activation carte Visa',
      'Prime 20 € versée le 16 du mois suivant l\'ouverture ; 60 € sous 2 mois après alimentation ; 40 € sous 3 mois après activation carte',
      'Maximum 5 parrainages par année glissante pour le parrain',
      'Valable à partir du 27 mars 2026',
    ],
    documents: [
      'Pièce d\'identité valide (CNI recto-verso ou passeport)',
      'Justificatif de domicile de moins de 3 mois',
    ...
    steps: [
      { num: 1, title: 'Obtiens le lien de parrainage', desc: 'Demande le lien ou code à ton parrain. Sans ce lien, la prime est perdue.', tag: 'App ou Web' },
      { num: 2, title: 'Inscris-toi via le lien', desc: 'Clique sur le lien parrainage et choisis ton offre (Pratiq+, Uniq ou Uniq+). Remplis le formulaire complet.', tag: 'Web' },
      { num: 3, title: 'Valide ton identité', desc: 'Upload CNI + justificatif de domicile. Vérification sous 24-72h.', tag: 'Web' },
      { num: 4, title: 'Alimente ton compte', desc: 'Vire 300 € minimum dans le mois suivant l\'ouverture pour déclencher la prime de 60 €.', tag: 'Web' },
      { num: 5, title: 'Active ta carte Visa', desc: 'Active ta carte dès réception (sous 7-10 jours). Cette étape débloque les 40 € supplémentaires.', tag: 'App' },
      { num: 6, title: 'Reçois tes primes étalées', desc: 'Les primes arrivent progressivement : ouverture → alimentation → activation carte, sur 3 mois.', tag: 'App' },
    ],
    tips: [
      'L\'Uniq+ maximise la prime parrain (50 €) — à prendre si le filleul prévoit de l\'utiliser activement',
      'Le versement de 300 € dans le mois est la clé pour les 60 € supplémentaires',
      'Active ta carte dès réception pour ne pas rater les 40 €',
      'Les 5 parrainages/an glissants permettent de parrainer régulièrement',
    ],
    warning: 'Si le filleul clôture son compte dans les 24 mois, Monabanq peut prélever la prime sur le compte courant.',
  },
  ...
  /* ─── BNP PARIBAS ─────────────────────────────────────── */
  {
    ...
    bonusFilleul: 'jusqu\'à 270 €',
    bonusParrain: '80 €',
    bonusTotal: 'jusqu\'à 350 €',
    highlight: 'Filleul : 80 € cash + gratuité carte + Services Essentiels Esprit Libre 1 an (jusqu\'à 191,88 €). Parrain : 80 € en ligne. Inscription avant 13/04/2026.',
    badge: 'Web & App',
    badgeColor: '#16a34a',
    minDeposit: 'Aucun dépôt minimum requis',
    timeline: 'Finalisation dans les 3 mois après la demande (avant 13/07/2026)',
    lastChecked: 'Avril 2026',
    sourceUrl: 'https://mabanque.bnpparibas.com/fr/decouvrir/parrainage',
    reliability: 'élevée',
    recommended: true,
    offerNote: 'Parrain en ligne : 80 € sur compte. Parrain en agence : cagnotte partenaire. Demande avant le 13/04/2026 à 15h.',
    conditions: [
      'Filleul : ouvrir un 1er compte courant en ligne sur mabanque.bnpparibas via le lien parrainage',
      'Souscrire aux Services Essentiels Esprit Libre (hors Visa Infinite)',
      'Demande de parrainage avant le 13/04/2026 à 15h',
      'Finalisation complète dans les 3 mois (avant le 13/07/2026)',
      'Toute inscription débutée hors lien parrainage = prime définitivement perdue',
      'Parrain en ligne : 80 € sur compte bancaire. Parrain en agence : cagnotte partenaire',
    ],
    documents: [
    ...
    steps: [
      { num: 1, title: 'Ouvre UNIQUEMENT via le lien parrainage', desc: 'CRITIQUE : toute ouverture sans le lien = prime perdue définitivement. Ne cherche pas BNP sur Google — clique directement sur le lien parrainage.', tag: 'Web' },
      { num: 2, title: 'Remplis le formulaire complet', desc: 'État civil, adresse, situation professionnelle. Choisis ton offre Services Essentiels Esprit Libre (hors Visa Infinite).', tag: 'Web' },
      { num: 3, title: 'Valide ton identité', desc: 'Upload pièce ID + justificatif domicile. Signature électronique via SMS.', tag: 'Web' },
      { num: 4, title: 'Finalise avant 13/07/2026', desc: 'Tu as 3 mois après la demande initiale pour finaliser l\'ouverture. Ne laisse pas traîner.', tag: 'Web' },
      { num: 5, title: 'Reçois tes avantages', desc: '80 € crédités + gratuité carte + Services Essentiels Esprit Libre offerts pendant 1 an.', tag: 'App' },
    ],
    tips: [
      'N\'ouvre JAMAIS BNP sans le lien parrainage — c\'est irrécupérable',
      'Les Services Essentiels Esprit Libre 1 an représentent jusqu\'à 191,88 € de valeur',
      'La demande doit être faite avant le 13/04/2026 à 15h — date proche !',
      'Finalisation dans les 3 mois : tu as jusqu\'au 13/07/2026',
    ],
    warning: 'Toute inscription débutée HORS lien parrainage = prime définitivement perdue, sans recours possible.',
  },
  ...
  /* ─── LA BANQUE POSTALE ───────────────────────────────── */
  {
    ...
    bonusParrain: '50 €',
    bonusTotal: '100 €',
    highlight: '50 € pour le parrain et 50 € pour le filleul. Valable jusqu\'au 31/12/2026.',
    badge: 'Web & App',
    badgeColor: '#f59e0b',
    minDeposit: 'Aucun dépôt minimum spécifié',
    timeline: 'Prime versée sous 3 mois après validation',
    lastChecked: 'Avril 2026',
    sourceUrl: 'https://www.labanquepostale.fr/parrainage',
    reliability: 'élevée',
    conditions: [
      'S\'inscrire via la plateforme parrainage La Banque Postale',
      'Souscrire une formule de compte (hors formule Simplicité)',
      'Ne pas être déjà client La Banque Postale',
      'Valable du 01/12/2025 au 31/12/2026',
    ],
    documents: [
    ...
    steps: [
      { num: 1, title: 'Obtiens le lien/code parrainage', desc: 'Demande le lien ou code à ton parrain. L\'inscription doit se faire via la plateforme parrainage officielle.', tag: 'Web' },
      { num: 2, title: 'Inscris-toi via la plateforme', desc: 'Clique sur le lien et souscris une formule de compte (hors Simplicité). Remplis le formulaire complet.', tag: 'Web' },
      { num: 3, title: 'Valide ton identité', desc: 'Upload les documents requis. Validation sous 48-72h.', tag: 'Web' },
      { num: 4, title: 'Reçois ta prime', desc: 'La prime de 50 € est versée sous 3 mois après validation des conditions.', tag: 'App' },
    ],
    tips: [
      'Offre valable jusqu\'au 31/12/2026 — prends le temps de choisir le bon moment',
      'Évite la formule Simplicité qui n\'est pas éligible',
      'La Banque Postale est accessible dans tous les bureaux de poste',
    ],
    warning: 'Hors formule Simplicité. Vérifiez les conditions sur labanquepostale.fr avant de souscrire.',
  },
  ...
  /* ─── TRADE REPUBLIC ──────────────────────────────────── */
  {
    ...
    highlight: 'Parrain : jusqu\'à 200 € en espèces. Filleul : jusqu\'à 200 € en actions. Conditions : compte validé + 1er investissement.',
    ...
    conditions: [
      'Compte Trade Republic validé + 1er investissement effectué par le filleul',
      'Filleul : jamais eu de compte Trade Republic',
      'Parrain reçoit jusqu\'à 200 € en espèces, filleul jusqu\'à 200 € en actions',
      'INTERDIT de partager son lien sur les réseaux sociaux, forums ou plateformes de parrainage',
      'Non-respect = exclusion définitive du programme de parrainage',
    ],
    documents: [
      'Pièce d\'identité valide (CNI ou passeport)',
    ...
    steps: [
      { num: 1, title: 'Obtiens le lien en direct', desc: 'IMPORTANT : le partage du lien sur réseaux sociaux ou forums est interdit. Le parrain doit partager son lien uniquement en direct (SMS, email, en personne).', tag: 'App' },
      { num: 2, title: 'Télécharge l\'app et crée ton compte', desc: 'Télécharge Trade Republic depuis le lien parrain. Crée ton compte : état civil, vérification d\'identité biométrique.', tag: 'App' },
      { num: 3, title: 'Effectue ton 1er investissement', desc: 'Dépose et effectue un 1er investissement (même 1 €). Cette étape est obligatoire pour valider le parrainage.', tag: 'App' },
    ...
    tips: [
      ...
      'Les actions reçues en bonus peuvent être conservées ou vendues',
      'Partage uniquement en direct — jamais sur un forum ou réseau social',
      'Excellent pour débuter en bourse avec une interface simple',
    ],
    warning: 'Partage du lien INTERDIT sur réseaux sociaux, forums ou plateformes de parrainage spécialisées. Exclusion définitive du programme en cas de non-respect.',
  },
