...
export const PLATFORMS: Platform[] = [
  ...
  /* ─── ROBINHOOD ──────────────────────────────────────── */
  {
    ...
    bonusParrain: '60 €',
    bonusTotal: '100 €',
    highlight: '40 € en cryptomonnaie offerts en créant un compte via mon lien et en déposant 50 € pour commencer à trader.',
    badge: 'App uniquement',
    badgeColor: '#00c400',
    minDeposit: 'Dépôt minimum 50 €',
    timeline: 'Prime en crypto versée après dépôt de 50 €',
    lastChecked: 'Mai 2026',
    sourceUrl: 'https://join.robinhood.com/eu_crypto/mathisc-6013cc/',
    referralUrl: 'https://join.robinhood.com/eu_crypto/mathisc-6013cc/',
    reliability: 'élevée',
    recommended: true,
    conditions: [
      'Créer un compte via le lien de parrainage (obligatoire)',
      'Déposer au moins 50 € pour commencer à trader',
      'Prime de 40 € versée en cryptomonnaie après dépôt',
    ],
    documents: [
      'Pièce d\'identité valide (CNI ou passeport)',
    ...
    steps: [
      { num: 1, title: 'Inscris-toi via le lien parrain', desc: 'Clique sur mon lien de parrainage — obligatoire pour que le bonus soit comptabilisé.', tag: 'App' },
      { num: 2, title: 'Crée ton compte et vérifie ton identité', desc: 'Remplis le formulaire et envoie ta pièce d\'identité. Validation rapide.', tag: 'App' },
      { num: 3, title: 'Dépose 50 € minimum', desc: 'Un dépôt de 50 € suffit pour débloquer les 40 € en cryptomonnaie. Le parrain reçoit 60 € simultanément.', tag: 'App' },
    ],
    tips: [
      'Seul le lien de parrainage active le bonus — pas d\'ajout possible après l\'inscription',
      '50 € de dépôt suffisent pour débloquer 40 € en crypto — excellent ROI',
    ],
  },
  ...
  /* ─── HELLO BANK ──────────────────────────────────────── */
  {
    ...
    bonusParrain: '80 €',
    bonusTotal: '160 €',
    highlight: '80 € pour le filleul et 80 € pour le parrain. Maximum 10 parrainages par an.',
    badge: 'Web & App',
    badgeColor: '#0ea5e9',
  ...
  /* ─── OKX ─────────────────────────────────────────────── */
  {
    ...
    bonusFilleul: 'jusqu\'à 300 €',
    bonusParrain: '80 € par ami',
    bonusTotal: 'jusqu\'à 1 100 €',
    highlight: 'Parrain : 80 € par ami parrainé, jusqu\'à 10 amis (800 € max). Filleul : jusqu\'à 300 € de récompenses de bienvenue.',
    badge: 'Web & App',
    badgeColor: '#f0b90b',
    minDeposit: 'Dépôt minimum 2 000 €',
    timeline: 'Récompense versée une fois l\'objectif filleul atteint',
    lastChecked: 'Mai 2026',
    sourceUrl: 'https://www.okx.com/fr-fr/referral',
    reliability: 'élevée',
    recommended: true,
    referralCode: '49834320',
    offerNote: 'Parrain : 80 € par ami, max 10 toutes les 2 semaines (800 € max). Montants actualisés toutes les 2 semaines selon conditions du marché.',
    conditions: [
      'Créer un compte OKX via le lien de parrainage',
      'Vérifier son identité (KYC)',
      'Filleul : accomplir la tâche assignée pour débloquer les récompenses',
      'Parrain : max 10 récompenses toutes les 2 semaines',
      'Comportement malhonnête ou abusif → récompense non versée',
    ],
    documents: [
      'Pièce d\'identité valide (CNI ou passeport)',
      'Selfie biométrique',
    ...
    steps: [
      { num: 1, title: 'Inscris-toi via le lien parrain', desc: 'Clique sur le lien de parrainage ou saisis le code 49834320. Sans lien/code, le parrainage ne sera pas lié.', tag: 'Web' },
      { num: 2, title: 'Vérifie ton identité (KYC)', desc: 'Pièce ID + selfie biométrique. Obligatoire pour débloquer les récompenses.', tag: 'App ou Web' },
      { num: 3, title: 'Accomplis ta tâche', desc: 'OKX t\'assigne une tâche spécifique (dépôt, trade...). Accomplis-la pour débloquer jusqu\'à 300 € de récompenses.', tag: 'App ou Web' },
      { num: 4, title: 'Parrain reçoit 80 €', desc: 'Dès que ton ami a accompli sa tâche, tu reçois automatiquement 80 €. Répète jusqu\'à 10 fois toutes les 2 semaines.', tag: 'App' },
    ],
    tips: [
      'Parrain : consulte le montant de ta récompense dans l\'historique des invitations (actualisé toutes les 2 semaines)',
      'OKX propose aussi du staking, des bots de trading et plus de 300 cryptos',
      'Paiements supportés : SEPA, Apple Pay, Visa, Mastercard',
    ],
  },
