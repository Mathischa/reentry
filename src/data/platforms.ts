...
export const PLATFORMS: Platform[] = [
  ...
  /* ─── SCRAMBLY ────────────────────────────────────────── */
  {
    ...
    bonusParrain: '10 €',
    bonusTotal: '20 €',
    highlight: '10 € pour le parrain et 10 € pour le filleul. App de cashback et récompenses.',
    badge: 'App uniquement',
    badgeColor: '#a855f7',
    minDeposit: 'Aucun dépôt minimum',
  ...
  /* ─── JOKO ────────────────────────────────────────────── */
  {
    ...
    bonusParrain: '30 €',
    bonusTotal: '60 €',
    highlight: '30 € pour le parrain et 30 € pour le filleul. App de cashback sur tes achats en ligne.',
    badge: 'App uniquement',
    badgeColor: '#ec4899',
    minDeposit: 'Aucun dépôt minimum',
    timeline: 'Bonus crédité après validation du compte',
