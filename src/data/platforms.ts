...
export const PLATFORMS: Platform[] = [
  ...
  /* ─── ROBINHOOD ──────────────────────────────────────── */
  {
    ...
    bonusParrain: '60 €',
    bonusTotal: '100 €',
    highlight: '40 € en cryptomonnaie offerts en créant un compte via mon lien et en déposant 20 € pour commencer à trader.',
    badge: 'App uniquement',
    badgeColor: '#00c400',
    minDeposit: 'Dépôt minimum 20 €',
    timeline: 'Prime en crypto versée après dépôt de 20 €',
    ...
    conditions: [
      ...
      'Déposer au moins 20 € pour commencer à trader',
    ...
    steps: [
      ...
      { num: 3, title: 'Dépose 20 € minimum', desc: 'Un dépôt de 20 € suffit pour débloquer les 40 € en cryptomonnaie. Le parrain reçoit 60 € simultanément.', tag: 'App' },
    ],
    tips: [
      'Seul le lien de parrainage active le bonus — pas d\'ajout possible après l\'inscription',
      '20 € de dépôt suffisent pour débloquer 40 € en crypto — excellent ROI',
    ],
  },
