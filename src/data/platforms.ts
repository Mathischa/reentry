...
export const PLATFORMS: Platform[] = [
  ...
  /* ─── BETCLIC ─────────────────────────────────────────── */
  {
    ...
    bonusParrain: '20 € par ami',
    bonusTotal: '120 €',
    highlight: '1er pari perdant remboursé jusqu\'à 100€ en cash — 20€ pour le parrain dès inscription du filleul.',
    badge: 'Web & App',
    badgeColor: '#e8001c',
    ...
    conditions: [
      ...
      'Le parrain reçoit 20€ dès l\'inscription validée du filleul',
    ],
    documents: [
    ...
    steps: [
      ...
      { num: 6, title: 'Remboursement si pari perdu', desc: 'Si tu perds, Betclic rembourse en Freebets sous 72h (jusqu\'à 100€). Les freebets ont une condition de mise avant retrait — lis bien les CGU.', tag: 'App' },
      { num: 7, title: 'Prime parrain créditée', desc: 'Ton parrain reçoit 20€ en cash (pas des freebets !) sur son compte Betclic dès que ton inscription est validée.', tag: 'App' },
    ],
    tips: [
      'Parie sur une cote ≥ 1.70 pour maximiser l\'utilité du remboursement',
      ...
      'Le parrain reçoit ses 20€ en cash, pas des freebets — directement retirable',
    ],
