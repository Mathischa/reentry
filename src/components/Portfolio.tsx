  ...
  return (
    <section id="portfolio" className="py-24 px-5 sm:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="section-title">Notre <GradientText>première réalisation</GradientText></h2>
        ...
        <div className="mt-14 max-w-2xl mx-auto">
          <a
            ...
            className="group block rounded-3xl overflow-hidden border border-white/[0.07] bg-white/[0.02] hover:border-sky-500/30 transition-all duration-400 hover:scale-[1.015]"
            style={{ boxShadow: '0 0 0 0 rgba(14,165,233,0)' }}
            onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 0 50px rgba(14,165,233,0.08)')}
